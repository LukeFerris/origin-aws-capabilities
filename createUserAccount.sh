...
USER_POOL_ID=$(aws cloudformation describe-stack-resource --region=eu-central-1 --stack-name=o-[SOLUTION_ID_SHORT]-[USERNAME_LOWER]-[MODE] --logical-resource-id=[CELL_ID]UserPool --output=text --query=StackResourceDetail.PhysicalResourceId)
